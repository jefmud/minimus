...
class Session:
    ...
    def __init__(self, app, sessions_dir='./sessions', cookie_name='msession', mode='file', days=365):
        ...
        self._mode = mode # file or memcached (FUTURE)
    ...
    def _load(self, session_key=None):
        ...
        if self._mode == 'file':
            ...
            Exception(f"session unknown or unsupported mode: {self._mode}")
    ...
    def _save(self, session_key=None):
        ...
        if self._mode == 'file':
            ...
            raise Exception(f"session unknown or unsupported mode: {self._mode}")
...
def get_cookies(environ, secret=None):
    ...
    Returns:
        dict: a dictionary-like object of cookies
    """
